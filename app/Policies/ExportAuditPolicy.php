...
class ExportAuditPolicy
{
    ...
    {
        return $user->id === $exportAudit->user_id;
    }
     ...
     */
    public function restore(User $user, ExportAudit $exportAudit): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, ExportAudit $exportAudit): bool
    {
        return false;
    }
}
